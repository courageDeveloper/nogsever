...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, private alertctrl: AlertController, private plt: Platform, public db: PouchService, private localNotification: LocalNotifications) {
