...
/**
 * Generated class for the ViewnewpreventivemaintenancePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-viewnewpreventivemaintenance',
  templateUrl: 'viewnewpreventivemaintenance.html',
  animations: [
...
export class ViewnewpreventivemaintenancePage {
  ...
  ionViewDidLoad() {
    ...
    console.log('ionViewDidLoad ViewnewpreventivemaintenancePage');
  ...
  openWorkorder(preventivemaintenance) {
    let modal = this.modalCtrl.create('ViewfrequencyequipmentPage', { type: 'View', equipment: this.equipment, preventivemaintenance: preventivemaintenance });
