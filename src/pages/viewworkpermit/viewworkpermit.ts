...
export class ViewworkpermitPage {
  ...
  constructor(public navCtrl: NavController, private platform: Platform, public modalCtrl: ModalController, public viewCtrl: ViewController, public httpService: HttpserviceProvider, public alertCtrl: AlertController, public db: PouchService, public navParams: NavParams) {
        ...
        inputs: [
          {
            name: 'message',
            type: 'text',
            placeholder: 'Enter ypur reasons for disapproving'
          }
        ],
        buttons: [
          {
