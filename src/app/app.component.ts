...
export class MyApp {
  ...
  constructor(platform: Platform, private oneSignal: OneSignal, public httpService: HttpserviceProvider, statusBar: StatusBar, public db: PouchService, splashScreen: SplashScreen, public popUp: PopupProvider) {
    platform.ready().then(() => {
