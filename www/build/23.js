...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PreventivemaintenancePageModule", function() { return PreventivemaintenancePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__preventivemaintenance__ = __webpack_require__(862);
...
var PreventivemaintenancePageModule = /** @class */ (function () {
    function PreventivemaintenancePageModule() {
    }
    PreventivemaintenancePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__preventivemaintenance__["a" /* PreventivemaintenancePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__preventivemaintenance__["a" /* PreventivemaintenancePage */]),
            ],
        })
    ], PreventivemaintenancePageModule);
    return PreventivemaintenancePageModule;
}());

//# sourceMappingURL=preventivemaintenance.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PreventivemaintenancePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
 ...
 */
var PreventivemaintenancePage = /** @class */ (function () {
    function PreventivemaintenancePage(navCtrl, platform, httpService, alertCtrl, db, navParams, modalCtrl) {
    ...
    PreventivemaintenancePage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    PreventivemaintenancePage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
        this.db.getSupervisor(this.localStorageItem).then(function (item) {
            _this.user = item;
    ...
    PreventivemaintenancePage.prototype._loadWorkorders = function () {
    ...
    PreventivemaintenancePage.prototype.loadAlarm = function () {
        var _this = this;
    ...
    PreventivemaintenancePage.prototype.loadAlarmWO = function () {
        var _this = this;
        this.db.getWorkorders().then(function (items) {
            items = items.filter(function (data) { return data.frequencyspandate == ""; });
            items.forEach(function (workorder) {
    ...
    PreventivemaintenancePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    PreventivemaintenancePage.prototype.filterWorkorders = function ($event) {
    ...
    PreventivemaintenancePage.prototype.newWorkorder = function () {
        var _this = this;
        var modal = this.modalCtrl.create('AddpreventivemaintenancePage', { type: 'Add' });
    ...
    PreventivemaintenancePage.prototype.openWorkorder = function (workorder) {
        var _this = this;
        var modal = this.modalCtrl.create('AddpreventivemaintenancePage', { type: 'Edit', workorder: workorder });
        modal.onDidDismiss(function (data) {
            _this._loadWorkorders();
        });
        modal.present();
    };
    PreventivemaintenancePage.prototype.ackWo = function (workorder) {
        workorder.status = true;
        workorder.dstatus = false;
        this.db.updateWorkorder(workorder).then(function (res) {
        });
    };
    PreventivemaintenancePage.prototype.disackWo = function (workorder) {
        workorder.dstatus = true;
        workorder.status = false;
        this.db.updateWorkorder(workorder).then(function (res) {
        });
    };
    PreventivemaintenancePage.prototype.navPtw = function (workorder) {
        var _this = this;
    ...
    PreventivemaintenancePage.prototype.deleteWorkorder = function (workorder) {
        var _this = this;
