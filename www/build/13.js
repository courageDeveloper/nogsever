...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddorderequipmentPageModule", function() { return AddorderequipmentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addorderequipment__ = __webpack_require__(870);
...
var AddorderequipmentPageModule = /** @class */ (function () {
    function AddorderequipmentPageModule() {
    }
    AddorderequipmentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__addorderequipment__["a" /* AddorderequipmentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__addorderequipment__["a" /* AddorderequipmentPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ionic_tooltips__["a" /* TooltipsModule */].forRoot()
            ],
        })
    ], AddorderequipmentPageModule);
    return AddorderequipmentPageModule;
}());

//# sourceMappingURL=addorderequipment.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddorderequipmentPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
 ...
 */
var AddorderequipmentPage = /** @class */ (function () {
    function AddorderequipmentPage(navCtrl, formBuilder, viewCtrl, httpService, db, navParams, platform) {
        var _this = this;
    ...
    AddorderequipmentPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        ...
        this.db.getWorkorder(this.equipment.woId).then(function (res) {
            if (res == undefined) {
                _this.equipment.woId = '';
                _this.db.updateEquipmentcat(_this.equipment).then(function (res) {
                });
            }
        });
    };
    AddorderequipmentPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
        this.db.getSupervisor(this.localStorageItem).then(function (item) {
            _this.user = item;
    ...
    AddorderequipmentPage.prototype.initItemArray = function () {
    ...
    AddorderequipmentPage.prototype.addItemArray = function () {
    ...
    AddorderequipmentPage.prototype.selectEquipmentsCats = function (newVal) {
    ...
    AddorderequipmentPage.prototype.selectEquipmentsTags = function (newVal) {
    ...
    AddorderequipmentPage.prototype.selectEquipmentsParts = function (newVal) {
    ...
    AddorderequipmentPage.prototype.selectEquipmentsPartsTags = function (newVal) {
    ...
    AddorderequipmentPage.prototype.submit = function () {
        var _this = this;
    ...
    return AddorderequipmentPage;
}());

//# sourceMappingURL=addorderequipment.js.map
