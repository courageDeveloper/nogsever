...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FixedPageModule", function() { return FixedPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fixed__ = __webpack_require__(842);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ack_angular_webcam__ = __webpack_require__(821);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ack_angular_webcam___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_ack_angular_webcam__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__ = __webpack_require__(380);
...
var FixedPageModule = /** @class */ (function () {
    function FixedPageModule() {
    }
    FixedPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__fixed__["a" /* FixedPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__fixed__["a" /* FixedPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ack_angular_webcam__["WebCamModule"],
                __WEBPACK_IMPORTED_MODULE_4_ionic_img_viewer__["a" /* IonicImageViewerModule */]
            ],
        })
    ], FixedPageModule);
    return FixedPageModule;
}());

//# sourceMappingURL=fixed.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(819);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_httpservice__ = __webpack_require__(169);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var FixedPage = /** @class */ (function () {
    function FixedPage(httpService, viewCtrl, platform, navCtrl, actionSheetCtrl, navParams, _DomSanitizer, db) {
    ...
    FixedPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    FixedPage.prototype.picture = function () {
        var _this = this;
    ...
    FixedPage.prototype.camera = function () {
        var _this = this;
    ...
    FixedPage.prototype.gallery = function () {
        var _this = this;
    ...
    FixedPage.prototype.onCamError = function (err) { };
    FixedPage.prototype.onCamSuccess = function () { };
    FixedPage.prototype.handleFiles = function (event) {
        var myThis = this;
        this.files = event.target.files;
        var fileIndex = __WEBPACK_IMPORTED_MODULE_3_lodash__["range"](this.files.length);
    ...
    FixedPage.prototype.submit = function (workpermit) {
        var _this = this;
        if (this.type == 'workpermit') {
            workpermit.fixed = true;
            this.db.updateWorkpermit(workpermit).then(function (res) {
                ...
                _this.db.getSupervisors().then(function (supervisors) {
                    ...
                    _this.httpService.sendEmailFixed(emailInfo).subscribe(function (res) {
                    });
                    //if (this.platform.is('cordova')) {
            ...
            this.db.updatefaultregistry(workpermit).then(function (res) {
                _this.viewCtrl.dismiss();
                _this.db.getSupervisors().then(function (supervisors) {
                    _this.filterManager = supervisors.filter(function (data) { return data.post == 'Manager'; });
                    _this.filterHse = supervisors.filter(function (data) { return data.departments == 'HSE'; });
