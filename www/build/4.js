...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkpermitPageModule", function() { return WorkpermitPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workpermit__ = __webpack_require__(874);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_email_composer__ = __webpack_require__(826);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_common_http__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ack_angular_webcam__ = __webpack_require__(821);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ionic_img_viewer__ = __webpack_require__(380);
...
var WorkpermitPageModule = /** @class */ (function () {
    function WorkpermitPageModule() {
    }
    WorkpermitPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__workpermit__["a" /* WorkpermitPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__workpermit__["a" /* WorkpermitPage */]),
    ...
    ], WorkpermitPageModule);
    return WorkpermitPageModule;
}());

//# sourceMappingURL=workpermit.module.js.map
...
var videoHelp_1 = __webpack_require__(805);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42), __webpack_require__(820)(module)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var webcam_component_1 = __webpack_require__(804);
exports.WebCamComponent = webcam_component_1.WebCamComponent;
var webcam_module_1 = __webpack_require__(822);
...
var core_1 = __webpack_require__(1);
var webcam_component_1 = __webpack_require__(804);
var AckMediaDevices_directive_1 = __webpack_require__(823);
var declarations = [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash__ = __webpack_require__(819);
...
var WorkpermitPage = /** @class */ (function () {
    function WorkpermitPage(navCtrl, _DomSanitizer, platform, actionSheetCtrl, httpService, emailcomposer, alertCtrl, viewCtrl, navParams, db) {
        var _this = this;
        ...
        if (this.navParams.get('type') == 'Add') {
            ...
            this.db.getWorkpermits().then(function (data) {
                if (data.length != 0) {
                    _this.workpermit.ptwno = data[0].ptwno + 1;
                }
                else {
                    _this.workpermit.ptwno = 1;
                }
            });
        }
    ...
    WorkpermitPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
        this.db.getSupervisor(this.localStorageItem).then(function (item) {
            _this.user = item;
    ...
    WorkpermitPage.prototype.selectEquipmentsCats = function (newVal) {
    ...
    WorkpermitPage.prototype.selectEquipmentsTags = function (newVal) {
    ...
    WorkpermitPage.prototype.selectEquipmentsParts = function (newVal) {
    ...
    WorkpermitPage.prototype.selectEquipmentsPartsTags = function (newVal) {
    ...
    WorkpermitPage.prototype.slideChanged = function () {
        var currentIndex = this.slides.getActiveIndex();
        this.slides.lockSwipes(true);
        this.startSlide = this.slides.isBeginning();
    };
    WorkpermitPage.prototype.next = function () {
        this.slides.lockSwipes(false);
        this.slides.slideNext(500, true);
    };
    WorkpermitPage.prototype.selectPMs = function (newVal) {
        this.pmName = newVal;
    };
    WorkpermitPage.prototype.prev = function () {
        this.slides.lockSwipes(false);
        this.slides.slidePrev(500, true);
    };
    WorkpermitPage.prototype.home = function () {
    ...
    WorkpermitPage.prototype.picture = function () {
        var _this = this;
    ...
    WorkpermitPage.prototype.camera = function () {
        var _this = this;
        if (this.platform.is('cordova')) {
            this.db.takePhoto().then(function (image) {
                _this.workpermit.picture = image.toString();
            }).catch(function (err) {
                console.log(err);
            });
        }
    ...
    WorkpermitPage.prototype.gallery = function () {
        var _this = this;
        this.db.selectPhotograph().then(function (image) {
            _this.workpermit.picture = image.toString();
        }).catch(function (err) {
            console.log(err);
        });
    };
    WorkpermitPage.prototype.onCamError = function (err) { };
    WorkpermitPage.prototype.onCamSuccess = function () { };
    WorkpermitPage.prototype.handleFiles = function (event) {
        var myThis = this;
        this.files = event.target.files;
        var fileIndex = __WEBPACK_IMPORTED_MODULE_6_lodash__["range"](this.files.length);
    ...
    WorkpermitPage.prototype.submit = function () {
        var _this = this;
        if (this.add || this.workorder) {
            ...
            this.db.saveWorkpermit(this.workpermit).then(function (res) {
                _this.navCtrl.push('ViewworkpermitPage');
                ...
                _this.user.workpermits.push(res.id);
                _this.db.updateSupervisor(_this.user).then(function (res) {
                });
            });
        }
        else {
            ...
            this.workpermit.department = this.user.departments;
            this.workpermit.post = this.user.post;
            this.db.updateWorkpermit(this.workpermit).then(function (result) {
                _this.viewCtrl.dismiss();
            });
        }
    };
    WorkpermitPage.prototype.openAlert = function () {
    ...
    ], WorkpermitPage.prototype, "slides", void 0);
    WorkpermitPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-workpermit',template:/*ion-inline-start:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\workpermit\workpermit.html"*/'<!--\n\n  Generated template for the RegisterPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-toolbar color="primary">\n\n    <ion-title>\n\n      <ion-buttons>\n\n        <button (click)="home()" ion-button icon-only>\n\n                    <ion-icon name="ios-home"></ion-icon>\n\n                </button>\n\n      </ion-buttons>\n\n    </ion-title>\n\n\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n\n<!-- Themes  register-flat-->\n\n<ion-content class="background-image">\n\n  <ion-grid no-padding class="bg-color">\n\n    <ion-row header align-items-start align-items-stretch>\n\n      <!-- Section form>-->\n\n      <ion-col col-10 offset-1 col-md-6 offset-md-3>\n\n        <ion-slides (ionSlideDidChange)="slideChanged()">\n\n          <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>WORK PERMIT</strong></h1>\n\n                </ion-col>\n\n              </ion-row>\n\n              <!-- Input-field -->\n\n              <ion-row>\n\n                <ion-col col-12>\n\n                <fieldset [disabled] = \'disabled\'>\n\n                  <div input-field>\n\n                    <!-- Input-field-text -->\n\n                    <ion-item>\n\n                      <ion-input placeholder="PTWONO" type="text"\n\n                        [(ngModel)]="workpermit.ptwno" name="ptwno" disabled></ion-input>\n\n                    </ion-item>\n\n                  </div>\n\n                </fieldset>\n\n                  <br>\n\n                  <!-- Login button -->\n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="next()">Next</button>\n\n                  </ion-col>\n\n                </ion-col>\n\n              </ion-row>\n\n            </form>\n\n          </ion-slide>\n\n          <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>WORK PERMIT</strong></h1>\n\n                </ion-col>\n\n              </ion-row>\n\n              <!-- Input-field -->\n\n              <ion-row>\n\n                <ion-col col-12>\n\n                <fieldset [disabled] = \'disabled\'>\n\n                  <div input-field>\n\n                    <!-- Input-field-date -->\n\n                    <ion-item no-padding>\n\n                      <ion-icon item-right name="md-calendar"></ion-icon>\n\n                      <ion-input class="text-input" [(ngModel)]="workpermit.datecreated" type="date" placeholder="Date Created" name="datecreated" required></ion-input>\n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-faculty -->\n\n                    <ion-item no-padding>\n\n                      <ion-input class="text-input" type="text" [(ngModel)]="workpermit.faculty" placeholder="Facility/Installation" name="faculty" required disabled></ion-input>\n\n                  \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-location -->\n\n                    <ion-item no-padding>\n\n                      <ion-input class="text-input" [(ngModel)]="workpermit.exactlocation" type="text" placeholder="Exact Location" name="exactlocation" required></ion-input>\n\n                      \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-description -->\n\n                    <ion-item no-padding>\n\n                      <ion-textarea class="text-input" [(ngModel)]="workpermit.description" type="text" placeholder="Description of Work" name="description" required></ion-textarea>\n\n                      \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                  <ion-item no-padding>\n\n                      <ion-input ng2-auto-complete [source]="equipmentsCatArray" list-formatter="name" (valueChanged)="selectEquipmentsCats($event)" placeholder="Main Equipment Name" type="text" [(ngModel)]="workpermit.equipmentcatname" name="equipmentcatname"></ion-input>\n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                      <ion-item no-padding>\n\n                          <ion-input ng2-auto-complete [source]="equipmentsTagArray" list-formatter="tag" (valueChanged)="selectEquipmentsTags($event)" placeholder="Main Equipment Tag" type="text" [(ngModel)]="workpermit.equipmenttag" name="equipmenttag"></ion-input>\n\n                        </ion-item>\n\n                      </div>\n\n                  <div input-field>\n\n                    <ion-item no-padding>\n\n                      <ion-input ng2-auto-complete [source]="equipmentsPartArray" list-formatter="name" (valueChanged)="selectEquipmentsParts($event)" placeholder="Part Name" type="text" [(ngModel)]="workpermit.equipmentpartname" name="equipmentpartname"></ion-input>\n\n                    </ion-item>\n\n                  </div>\n\n                 <div input-field>\n\n                    <ion-item no-padding>\n\n                      <ion-input ng2-auto-complete [source]="equipmentsPartTagArray" list-formatter="tag" (valueChanged)="selectEquipmentsPartsTags($event)" placeholder="Part Tag" type="text" [(ngModel)]="workpermit.tagname" name="tagname"></ion-input>\n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-equipments -->\n\n                    <ion-item no-padding>\n\n                      <ion-textarea class="text-input" [(ngModel)]="workpermit.equipments" type="text" placeholder="Equipments,Tools or Material to be used" name="equipments" required></ion-textarea>\n\n                      \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-password -->\n\n                    <ion-item no-padding>\n\n                      <ion-icon item-right name="md-calendar"></ion-icon>\n\n                      <ion-input class="text-input" [(ngModel)]="workpermit.startdate" type="date" placeholder="Start Date" name="startdate" required></ion-input>\n\n                      \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-password -->\n\n                    <ion-item no-padding>\n\n                      <ion-icon item-right name="md-calendar"></ion-icon>\n\n                      <ion-input class="text-input" [(ngModel)]="workpermit.enddate" type="date" placeholder="End Date" name="enddate" required></ion-input>\n\n                      \n\n                    </ion-item>\n\n                  </div>\n\n                  <div input-field>\n\n                    <!-- Input-field-password -->\n\n                    <ion-item no-padding>\n\n                      <ion-input class="text-input" [(ngModel)]="workpermit.noofworkers" type="number" placeholder="No of Workers" name="noofworkers" required></ion-input>\n\n                      <!-- <ion-label no-margin *ngIf="!isPasswordValid">{{data.errorPassword}}</ion-label> -->\n\n                    </ion-item>\n\n                  </div>\n\n                </fieldset>\n\n                  <br>\n\n                  <!-- Login button -->\n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="next()">Next</button>\n\n                  </ion-col>\n\n                </ion-col>\n\n              </ion-row>\n\n            </form>\n\n          </ion-slide>\n\n          <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>WORK PERMIT</strong></h1>\n\n                  <br>\n\n                  <div>\n\n                    <h2 class="danger"> Safety Precautions to be carried out</h2> \n\n                    <button ion-button small class="pre-color" (click)="openAlert()"><ion-icon name="md-clipboard"></ion-icon></button>\n\n                  </div>\n\n                </ion-col>\n\n              </ion-row>\n\n              <!-- Input-field -->\n\n              <ion-row>\n\n                    <ion-col col-12>\n\n                <fieldset [disabled] = \'disabled\'>\n\n                  <div input-field>\n\n                    <!-- Input-field-email -->\n\n                    <ion-item no-padding>\n\n                      <ion-textarea class="text-input" type="text" [(ngModel)]="workpermit.precautions" rows="7" name="precautions" placeholder="Safety Precautions"\n\n                        required></ion-textarea>\n\n                    </ion-item>\n\n                  </div>\n\n                  <br>\n\n                  <div input-field>\n\n                      <ion-item padding>\n\n                          <div><button ion-fab mini (click)="picture()" color="secondary">\n\n                        <ion-icon name="camera"></ion-icon>\n\n                        </button> Add picture of equipment to fix </div>\n\n                        <input *ngIf="showfileinput" type="file" accept="image/*" (change)="handleFiles($event)">\n\n                        <br />\n\n                        <input type="hidden" name="picture" [(ngModel)]="workpermit.picture">\n\n                        <ion-card *ngIf="oncam && !platform.is(\'cordova\')">\n\n                            <ack-webcam [(ref)]="webcam" [options]="options" (onSuccess)="onCamSuccess($event)" (onError)="onCamError($event)"></ack-webcam>\n\n                            <ion-card-content>\n\n                              <ion-item>\n\n                                <a ion-button block margin-bottom color="primary" (click)="camera()">\n\n                                      Snap\n\n                                    </a>\n\n                              </ion-item>\n\n                            </ion-card-content>\n\n                          </ion-card>\n\n                      </ion-item>\n\n                    <ion-item no-padding>\n\n                      <img imageViewer  [src]="_DomSanitizer.bypassSecurityTrustUrl(workpermit.picture)" />\n\n                    </ion-item>\n\n                  </div>\n\n                  <!-- Login button -->\n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="submit()">Submit</button>\n\n                  </ion-col>\n\n                </fieldset>\n\n                </ion-col>\n\n            </ion-row>\n\n            </form>\n\n          </ion-slide>\n\n          <!--  <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>WORK PERMIT</strong></h1>\n\n                  <br>\n\n                  <h2>AREA AUTHORITY</h2>\n\n                  <div> I authorise that work may be carried out <br> provided the stated precautions and preparations are <br> \n\n                   observed and clearance given by the Area Authority Site Supervisor.\n\n                  </div>\n\n                </ion-col>\n\n              </ion-row>\n\n              \n\n              <ion-row>\n\n                <ion-col col-12>\n\n                  <div input-field>\n\n                    \n\n                      <button ion-button medium color="attrgreen">APPROVE</button> \n\n                      <button ion-button medium color="danger">DISAPPROVE</button> \n\n                  </div>\n\n                  <br>\n\n                  \n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="next()">Next</button>\n\n                  </ion-col>\n\n                </ion-col>\n\n              </ion-row>\n\n            </form>\n\n          </ion-slide>\n\n            <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>WORK PERMIT</strong></h1>\n\n                  <br>\n\n                  <h2>AREA AUTHORITY (Site Supervisor)</h2>\n\n                  <div> I authorise that work may be carried out <br> provided the stated precautions and preparations are <br> \n\n                   observed and clearance given by the Area Authority Site Supervisor.\n\n                  </div>\n\n                </ion-col>\n\n              </ion-row>\n\n              \n\n              <ion-row>\n\n                <ion-col col-12>\n\n                  <div input-field>\n\n                    \n\n                      <button ion-button medium color="attrgreen">APPROVE</button> \n\n                      <button ion-button medium color="danger">DISAPPROVE</button> \n\n                  </div>\n\n                  <br>\n\n                  \n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="next()">Next</button>\n\n                  </ion-col>\n\n                </ion-col>\n\n              </ion-row>\n\n            </form>\n\n          </ion-slide>\n\n          <ion-slide>\n\n            <form padding>\n\n              <ion-row class="wlm-msg" align-items-start>\n\n                <ion-col align-self-baseline col-12>\n\n                  <ion-list text-center>\n\n                    <img src="assets/images/NOG-LOGO.jpg" class="img-size" />\n\n                  </ion-list>\n\n                  <h1><strong>Hi! We can’t wait to meet you!!</strong></h1>\n\n                </ion-col>\n\n              </ion-row>\n\n              \n\n              <ion-row>\n\n                <ion-col col-12>\n\n\n\n                  \n\n                  <ion-col col-12 no-padding>\n\n                    <button no-margin ion-button color="primary" full text-uppercase (click)="submit(users)">Submit</button>\n\n                  </ion-col>\n\n                </ion-col>\n\n              </ion-row>\n\n            </form>\n\n          </ion-slide> -->\n\n        </ion-slides>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n  <ion-fab bottom right *ngIf="!startSlide">\n\n    <button ion-fab color="primary" (click)="prev()" mini> <ion-icon name="arrow-back">  </ion-icon> </button>\n\n  </ion-fab>\n\n</ion-content>'/*ion-inline-end:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\workpermit\workpermit.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_5__angular_platform_browser__["DomSanitizer"], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_3__providers_httpservice__["a" /* HttpserviceProvider */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_email_composer__["a" /* EmailComposer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__pouch_service_pouch_service__["a" /* PouchService */]])
    ], WorkpermitPage);
    return WorkpermitPage;
}());

//# sourceMappingURL=workpermit.js.map
