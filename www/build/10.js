...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddfaultregistryPageModule", function() { return AddfaultregistryPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addfaultregistry__ = __webpack_require__(856);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ack_angular_webcam__ = __webpack_require__(821);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_img_viewer__ = __webpack_require__(380);
...
var AddfaultregistryPageModule = /** @class */ (function () {
    function AddfaultregistryPageModule() {
    }
    AddfaultregistryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__addfaultregistry__["a" /* AddfaultregistryPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__addfaultregistry__["a" /* AddfaultregistryPage */]),
    ...
    ], AddfaultregistryPageModule);
    return AddfaultregistryPageModule;
}());

//# sourceMappingURL=addfaultregistry.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddfaultregistryPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(819);
 ...
 */
var AddfaultregistryPage = /** @class */ (function () {
    function AddfaultregistryPage(actionSheetCtrl, navCtrl, _DomSanitizer, httpService, viewCtrl, navParams, platform, db) {
        var _this = this;
        ...
        if (this.navParams.get('type') == 'Add') {
            ...
            this.db.getfaultregistrys().then(function (data) {
                if (data.length != 0) {
                    _this.faultregistry.faultid = data[0].faultid + 1;
                }
                else {
                    _this.faultregistry.faultid = 1;
                }
            });
        }
    ...
    AddfaultregistryPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    AddfaultregistryPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
        this.db.getSupervisor(this.localStorageItem).then(function (item) {
            _this.user = item;
    ...
    AddfaultregistryPage.prototype.selectEquipmentsCats = function (newVal) {
    ...
    AddfaultregistryPage.prototype.selectEquipmentsTags = function (newVal) {
    ...
    AddfaultregistryPage.prototype.selectEquipmentsParts = function (newVal) {
    ...
    AddfaultregistryPage.prototype.selectEquipmentsPartsTags = function (newVal) {
    ...
    AddfaultregistryPage.prototype.picture = function () {
        var _this = this;
    ...
    AddfaultregistryPage.prototype.camera = function () {
        var _this = this;
        if (this.platform.is('cordova')) {
            this.db.takePhoto().then(function (image) {
                _this.faultregistry.picture = image.toString();
            }).catch(function (err) {
                console.log(err);
            });
        }
            ...
            if (this.oncam) {
                this.webcam.getBase64().then(function (base) {
                    _this.faultregistry.picture = base;
                    _this.oncam = false;
    ...
    AddfaultregistryPage.prototype.gallery = function () {
        var _this = this;
    ...
    AddfaultregistryPage.prototype.onCamError = function (err) { };
    AddfaultregistryPage.prototype.onCamSuccess = function () { };
    AddfaultregistryPage.prototype.handleFiles = function (event) {
        var myThis = this;
        this.files = event.target.files;
        var fileIndex = __WEBPACK_IMPORTED_MODULE_5_lodash__["range"](this.files.length);
    ...
    AddfaultregistryPage.prototype.submit = function () {
        var _this = this;
        if (this.add || this.addFromequip) {
            ...
            this.db.savefaultregistry(this.faultregistry).then(function (res) {
            ...
            this.db.updatefaultregistry(this.faultregistry).then(function (order) {
                _this.viewCtrl.dismiss(order);
            });
        }
    };
    AddfaultregistryPage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    AddfaultregistryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-addfaultregistry',template:/*ion-inline-start:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\addfaultregistry\addfaultregistry.html"*/'<ion-header>\n\n  <ion-navbar color="secondary">\n\n    <ion-buttons left>\n\n      <button color="primary" ion-button (click)="cancel()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title class="title-color">{{title}} Fault Registry</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="bg-primary50" padding>\n\n  <ion-fab top right edge *ngIf="platform.is(\'cordova\')">\n\n    <button ion-fab mini margin-left (click)="open()" color="secondary"><ion-icon name="phone-portrait"></ion-icon></button>\n\n  </ion-fab>\n\n\n\n  <form margin-top>\n\n    <fieldset [disabled]="disabled">\n\n      <ion-item>\n\n        <ion-input placeholder="Fault Number" type="text" [(ngModel)]="faultregistry.faultid" name="faultid" disabled></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input placeholder="Name" type="text" [(ngModel)]="faultregistry.name" name="name"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-icon item-right name="md-calendar"></ion-icon>\n\n        <ion-input placeholder="Date" type="date" [(ngModel)]="faultregistry.date" name="date"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input placeholder="Facility" type="text" [(ngModel)]="faultregistry.faculty" name="faculty" disabled></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input placeholder="Location" type="text" [(ngModel)]="faultregistry.location" name="location"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input ng2-auto-complete [source]="equipmentsCatArray" list-formatter="name" (valueChanged)="selectEquipmentsCats($event)"\n\n          placeholder="Equipment" type="text" [(ngModel)]="faultregistry.equipmentcatname" name="equipmentcatname"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input ng2-auto-complete [source]="equipmentsTagArray" list-formatter="tag" (valueChanged)="selectEquipmentsTags($event)"\n\n          placeholder="Equipment tag name" type="text" [(ngModel)]="faultregistry.equipmenttag" name="equipmenttag"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input ng2-auto-complete [source]="equipmentsPartArray" list-formatter="name" (valueChanged)="selectEquipmentsParts($event)"\n\n          placeholder="Equipment Part" type="text" [(ngModel)]="faultregistry.equipmentpartname" name="equipmentpartname"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-input ng2-auto-complete [source]="equipmentsPartTagArray" list-formatter="tag" (valueChanged)="selectEquipmentsPartsTags($event)"\n\n          placeholder="Equipment Part tag" type="text" [(ngModel)]="faultregistry.tagname" name="tagname"></ion-input>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-textarea placeholder="Description" type="text" [(ngModel)]="faultregistry.description" name="description"></ion-textarea>\n\n      </ion-item>\n\n      <div input-field>\n\n        <ion-item padding>\n\n          <div><button ion-fab mini (click)="picture()" color="secondary">\n\n              <ion-icon name="camera"></ion-icon>\n\n            </button> Add picture of equipment to fix </div>\n\n          <input *ngIf="showfileinput" type="file" accept="image/*" (change)="handleFiles($event)">\n\n          <br />\n\n          <input type="hidden" name="picture" [(ngModel)]="faultregistry.picture">\n\n          <ion-card *ngIf="oncam && !platform.is(\'cordova\')">\n\n            <ack-webcam [(ref)]="webcam" [options]="options" (onSuccess)="onCamSuccess($event)" (onError)="onCamError($event)"></ack-webcam>\n\n            <ion-card-content>\n\n              <ion-item>\n\n                <a ion-button block margin-bottom color="primary" (click)="camera()">\n\n                  Snap\n\n                </a>\n\n              </ion-item>\n\n            </ion-card-content>\n\n          </ion-card>\n\n        </ion-item>\n\n        <ion-item no-padding>\n\n          <img imageViewer [src]="_DomSanitizer.bypassSecurityTrustUrl(faultregistry.picture)" />\n\n        </ion-item>\n\n      </div>\n\n      <button ion-button type="submit" (click)="submit()" block>Submit</button>\n\n    </fieldset>\n\n  </form>\n\n</ion-content>'/*ion-inline-end:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\addfaultregistry\addfaultregistry.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["q" /* NavController */], __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser__["DomSanitizer"], __WEBPACK_IMPORTED_MODULE_3__providers_httpservice__["a" /* HttpserviceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__pouch_service_pouch_service__["a" /* PouchService */]])
    ], AddfaultregistryPage);
    return AddfaultregistryPage;
}());

//# sourceMappingURL=addfaultregistry.js.map
