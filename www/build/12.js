...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewfrequencyequipmentPageModule", function() { return ViewfrequencyequipmentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__viewfrequencyequipment__ = __webpack_require__(863);
...
var ViewfrequencyequipmentPageModule = /** @class */ (function () {
    function ViewfrequencyequipmentPageModule() {
    }
    ViewfrequencyequipmentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__viewfrequencyequipment__["a" /* ViewfrequencyequipmentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__viewfrequencyequipment__["a" /* ViewfrequencyequipmentPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ionic_tooltips__["a" /* TooltipsModule */].forRoot()
            ],
        })
    ], ViewfrequencyequipmentPageModule);
    return ViewfrequencyequipmentPageModule;
}());

//# sourceMappingURL=viewfrequencyequipment.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewfrequencyequipmentPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
 ...
 */
var ViewfrequencyequipmentPage = /** @class */ (function () {
    function ViewfrequencyequipmentPage(navCtrl, formBuilder, viewCtrl, httpService, db, navParams, platform) {
        var _this = this;
    ...
    ViewfrequencyequipmentPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    ViewfrequencyequipmentPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
        this.db.getSupervisor(this.localStorageItem).then(function (item) {
            _this.user = item;
    ...
    ViewfrequencyequipmentPage.prototype.initItemArray = function () {
    ...
    ViewfrequencyequipmentPage.prototype.addItemArray = function () {
    ...
    ViewfrequencyequipmentPage.prototype.selectEquipmentsCats = function (newVal) {
    ...
    ViewfrequencyequipmentPage.prototype.selectEquipmentsTags = function (newVal) {
    ...
    ViewfrequencyequipmentPage.prototype.selectEquipmentsParts = function (newVal) {
    ...
    ViewfrequencyequipmentPage.prototype.selectEquipmentsPartsTags = function (newVal) {
    ...
    ViewfrequencyequipmentPage.prototype.updateItem = function (objectItem, i, event) {
        if (event._value) {
            /* console.log(item, i);
    ...
    ViewfrequencyequipmentPage.prototype.submit = function (item, i, event) {
        this.preventivemaintenance.itemarray.splice(i, item);
    ...
    ViewfrequencyequipmentPage.prototype.submitNew = function () {
    ...
    ViewfrequencyequipmentPage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    ViewfrequencyequipmentPage.prototype.radioClick = function (event) {
        this.radioOther = true;
    };
    ViewfrequencyequipmentPage.prototype.radioClickMnth = function () {
        var monthHours = 30 * 24;
        this.preventivemaintenance.frequency = monthHours;
        this.radioOther = false;
    };
    ViewfrequencyequipmentPage.prototype.radioClickwek = function () {
        var weekHours = 7 * 24;
        this.preventivemaintenance.frequency = weekHours;
        this.radioOther = false;
    };
    ViewfrequencyequipmentPage.prototype.radioClickday = function () {
        var dailyHours = 24;
        this.preventivemaintenance.frequency = dailyHours;
        this.radioOther = false;
    };
    ViewfrequencyequipmentPage.prototype.deleteItem = function (item, i) {
    ...
    return ViewfrequencyequipmentPage;
}());

//# sourceMappingURL=viewfrequencyequipment.js.map
