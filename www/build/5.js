...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViewsubitemspmPageModule", function() { return ViewsubitemspmPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__viewsubitemspm__ = __webpack_require__(853);
...
var ViewsubitemspmPageModule = /** @class */ (function () {
    function ViewsubitemspmPageModule() {
    }
    ViewsubitemspmPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__viewsubitemspm__["a" /* ViewsubitemspmPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__viewsubitemspm__["a" /* ViewsubitemspmPage */]),
    ...
    ], ViewsubitemspmPageModule);
    return ViewsubitemspmPageModule;
}());

//# sourceMappingURL=viewsubitemspm.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ViewsubitemspmPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
 ...
 */
var ViewsubitemspmPage = /** @class */ (function () {
    function ViewsubitemspmPage(navCtrl, viewCtrl, httpService, navParams, platform, db) {
    ...
    ViewsubitemspmPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        console.log('ionViewDidLoad viewsubitemspmPage');
        this.db.getEquipmentcat(this.preventivemaintenance.equipmentcatid).then(function (data) {
            _this.equipment = data.name;
        });
    };
    ViewsubitemspmPage.prototype.ionViewDidEnter = function () {
        this.localStorageItem = JSON.parse(localStorage.getItem('user'));
    };
    ViewsubitemspmPage.prototype.cancel = function () {
        this.viewCtrl.dismiss();
    };
    ViewsubitemspmPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-viewsubitemspm',template:/*ion-inline-start:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\viewsubitemspm\viewsubitemspm.html"*/'<ion-header>\n\n  <ion-navbar color="secondary">\n\n    <ion-buttons left>\n\n      <button color="primary" ion-button (click)="cancel()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title class="title-color">{{title}} Sub Equipments</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <div class="margin-bottom">\n\n    <span> <b>MAIN EQUIPMENT:</b> {{equipment}} </span>\n\n  </div>\n\n\n\n  <div class="margin-bottom">\n\n    <span><b> DATE FOR NEXT REPAIRS:</b> {{preventivemaintenance.frequencyspandate | date}} </span>\n\n  </div>\n\n\n\n  <ion-list [virtualScroll]="preventivemaintenance.itemarray" [virtualTrackBy]="trackByName" [approxItemHeight]="\'200px\'">\n\n    <ion-item *virtualItem="let pm">\n\n      <ion-row>\n\n        <ion-col>\n\n          <div class="margin-bottom"> <strong text-uppercase> Sub-Equipments </strong> </div>\n\n          <div>\n\n            {{pm.maintenanceItem}}\n\n          </div>\n\n        </ion-col>\n\n        <ion-col>\n\n          <div class="margin-bottom"> <strong text-uppercase> Steps </strong></div>\n\n          <div>\n\n            {{pm.steps}}\n\n          </div>\n\n        </ion-col>\n\n      </ion-row>\n\n    </ion-item>\n\n    <hr>\n\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"C:\Users\IRORO\Desktop\ionicprojects\nogsever\src\pages\viewsubitemspm\viewsubitemspm.html"*/,
        }),
    ...
    return ViewsubitemspmPage;
}());

//# sourceMappingURL=viewsubitemspm.js.map
